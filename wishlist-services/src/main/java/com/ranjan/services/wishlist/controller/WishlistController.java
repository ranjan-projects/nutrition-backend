...
//            responses = {
//                    @ApiResponse(responseCode = "200", description = "Wishlist details", content = @Content(mediaType = "application/json", schema = @Schema(implementation = WishlistEntity.class))),
//                    @ApiResponse(responseCode = "404", description = "Wishlist not found"),
//                    @ApiResponse(responseCode = "500", description = "Something's gone wrong")
//            }
//    )
//    public ResponseEntity<WishlistEntity> getWishlistById(@PathVariable long id) {
